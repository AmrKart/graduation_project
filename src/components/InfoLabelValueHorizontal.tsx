...
const InfoLabelValueHorizontal = (props: InfoLabelValue) => {
    let sz = props.sz;
            ...
            <Col style={customStyle} className={`w-100`} sm={szTitle || sz}>
                <div>
                    ...
                    <p style={{ color: '#3D628D' }}>
                        {props.icon && <img width={18} src={props.icon} alt="" className='me-2' />}{translate(props.title)} : {!props.isLink && <span
                            style={{
...
export default InfoLabelValueHorizontal;
